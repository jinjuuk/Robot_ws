...
class ObjTrackingLightening(Node):
    def __init__(self):
        super().__init__('obj_tracking_lighting_node')
        ...
        # Define id_to_follow as an instance variable
        self.id_to_follow = 1  # Or set this to whatever ID you want to follow

        # Initialize a set to keep track of displayed objects
        self.displayed_objects = set()
    ...
    def color_image_callback(self, msg):
        ...
        for result in results:
            ...
            for box, track_id in zip(boxes, track_ids):
                ...
                #Use self.id_to_follow to access the instance variable
                if track_id != self.id_to_follow:
                    continue
